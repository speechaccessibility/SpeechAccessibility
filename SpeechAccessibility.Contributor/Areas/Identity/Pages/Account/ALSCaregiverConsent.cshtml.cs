...
namespace SpeechAccessibility.Areas.Identity.Pages.Account
{
    ...
    public class ALSCaregiverConsentModel : PageModel
    {
        ...
        public ALSCaregiverConsentModel(IdentityContext identityContext, IConfiguration config)
        {
        ...
        public IActionResult OnPostAsync()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                foreach (string name in consentNameList)
                {
                    ...
                    {
                        Version = _config["ALSCaregiverConsentVersion"],
