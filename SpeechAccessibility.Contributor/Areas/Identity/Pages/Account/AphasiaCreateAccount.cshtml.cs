...
{
    public class AphasiaCreateAccountModel : PageModel
    {      
        ...
        public AphasiaCreateAccountModel(SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager, ILogger<RegisterModel> logger, IMailService emailSender, IdentityContext context, IConfiguration config)
        {
        ...
        public void OnGet(Guid contributorId)
        {
            ...
            Input.LengthOfDiagnosis = contributor.LengthOfDiagnosis;
