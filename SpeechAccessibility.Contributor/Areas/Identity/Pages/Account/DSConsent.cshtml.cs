...
{
    [Authorize]
    public class DSConsentModel : PageModel
    {
        ...
        public DSConsentModel(IdentityContext identityContext, IConfiguration config)
        {
        ...
        public IActionResult OnPostAsync()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                foreach (string name in consentNameList)
                {
                    ...
                    {
                        Version = _config["DSConsentVersion"],
                ...
                {
                    return RedirectToPage("DSCaregiverConsent");
                }
                ...
                {
                    return RedirectToPage("DSAssent");
                }
