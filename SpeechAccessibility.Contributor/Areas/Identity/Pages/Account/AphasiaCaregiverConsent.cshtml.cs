...
namespace SpeechAccessibility.Areas.Identity.Pages.Account
{
    ...
    public class AphasiaCaregiverConsentModel : PageModel
    {
        ...
        public AphasiaCaregiverConsentModel(IdentityContext identityContext, IConfiguration config)
        {
        ...
        public IActionResult OnPostAsync()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                foreach (string name in consentNameList)
                {
                    ...
                    {
                        Version = _config["AphasiaCaregiverConsentVersion"],
