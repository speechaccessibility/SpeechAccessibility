...
namespace SpeechAccessibility.Areas.Identity.Pages.Account
{
    ...
    public class DSCaregiverConsentModel : PageModel
    {
        ...
        public DSCaregiverConsentModel(IdentityContext identityContext, IConfiguration config)
        {
        ...
        public IActionResult OnPostAsync()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                foreach (string name in consentNameList)
                {
                    ...
                    {
                        Version = _config["DSCaregiverConsentVersion"],
