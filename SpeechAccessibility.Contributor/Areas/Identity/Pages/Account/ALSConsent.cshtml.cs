...
{
    [Authorize]
    public class ALSConsentModel : PageModel
    {
        ...
        [Required]
        [BindProperty]
        public bool readAndUnderstandConsent { get; set;
        }
        [Required]
        [BindProperty]
        ...
        public  ALSConsentModel(IdentityContext identityContext, IConfiguration config)
        {
        ...
        public IActionResult OnPostAsync()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                foreach(string name in consentNameList)
                    ...
                    {
                        Version = _config["ALSConsentVersion"],
                ...
                {
                    return RedirectToPage("ALSCaregiverConsent");
                }
