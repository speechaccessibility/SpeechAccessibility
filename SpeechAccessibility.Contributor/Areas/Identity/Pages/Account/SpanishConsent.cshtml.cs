...
{
    [Authorize]
    public class SpanishConsentModel : PageModel
    {
        ...
        public SpanishConsentModel(IdentityContext identityContext, IConfiguration config)
        {
        ...
        public IActionResult OnPostAsync()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                foreach(string name in consentNameList)
                    ...
                    {
                        Version = _config["ConsentVersion"],
