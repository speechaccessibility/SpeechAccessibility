...
{
    [AllowAnonymous]
    public class ALSRegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [Display(Name = "Assistant Indicator")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if ("Yes".Equals(Input.HelperInd))
                ...
                {
                    ModelState.AddModelError("helperEmailValidation", "Assistant email is required.");
                }

                if (String.IsNullOrEmpty(Input.HelperFirstName))
                {
                    ModelState.AddModelError("helperFirstNameValidation", "Assistant first name is required.");
                }
                if (String.IsNullOrEmpty(Input.HelperLastName))
                {
                    ModelState.AddModelError("helperLastNameValidation", "Assistant last name is required.");
                }
                if (String.IsNullOrEmpty(Input.HelperPhoneNumber))
                {
                    ModelState.AddModelError("helperPhoneNumberValidation", "Assistant phone number is required.");
                }
                else
                {
                    ...
                    if (!result)
                    {
                        ModelState.AddModelError("helperPhoneNumberValidation", "Assistant phone number must be numeric.");
                    }
                }
