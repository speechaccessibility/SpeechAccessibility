...
{
    [Authorize]
    public class DeafConsentModel : PageModel
    {
        ...
        public  DeafConsentModel(IdentityContext identityContext, IConfiguration config)
        {
        ...
        public IActionResult OnPostAsync()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                foreach(string name in consentNameList)
                    ...
                    {
                        Version = _config["DeafConsentVersion"],
                ...
                return RedirectToPage("./DeafIntroductory");
            }
            else
            {
                return Page();
