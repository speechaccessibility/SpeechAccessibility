...
{
    public class CPAssentModel : PageModel
    {
        ...
        public CPAssentModel(IdentityContext identityContext, IConfiguration config)
        {
        ...
        public IActionResult OnPost()
        {
            if(ModelState.IsValid)
            {
                ...
                Assent assent = new Assent
                {
                    ...
                    Version = Int32.Parse(_config["CPAssentVersion"]),
